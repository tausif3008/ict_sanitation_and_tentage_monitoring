...
import SLAResolution from "../SLADashboard/SLAIssuResolution";
import IncidentsReport from "../IncidentDashborad/IncidentsReport";
...
const Dashboard = () => {
  return (
    <div className="grid grid-cols-4 mx-3 mt-3 gap-3 ">
      ...
      <div className="lg:col-span-4  lg:flex col-span-4 bg-white shadow-md mb-3 lg:mb-0 h-full rounded-md">
