        ...
        if (lastColumnData?.length === 0) {
            ...
            lastColumnData?.forEach((sectorData, idx) => {
                transformedData?.push({
                    ...
                    "Toilets & Tentage Type": idx === 0 ? row["Toilets & Tentage Type"] : "",
                    "Total Allotted Quantity": idx === 0 ? row["Total Allotted Quantity"] : "", // Only show on the first row in the grouping
                    Sector: sectorData[0] || "",
...
export const VendorDetailsToExcel = async (
    ...
    const columns = [
        ...
        { header: "Toilets & Tentage Type", key: "Toilets & Tentage Type", width: 30 },
        { header: "Total Allotted Quantity", key: "Total Allotted Quantity", width: 30 },
